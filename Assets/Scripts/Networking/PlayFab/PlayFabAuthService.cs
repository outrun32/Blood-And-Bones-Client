...
#if !DISABLE_PLAYFAB_CLIENTAPI
namespace PlayFab.Helpers
{
...
using Facebook.Unity;
    ...
    public class PlayFabAuthService
    {
        ...
        public delegate void PlayFabLinkEvent(Authtypes type, PlayFabError error = null);
        public static event PlayFabLinkEvent OnPlayFabLink;
        ...
        private void AuthenticateXbox()
        {

        }

        private void AuthenticatePSN() { }
